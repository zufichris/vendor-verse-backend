...
export class ProductService {
    ...
    async createProduct(dto: CreateProductDto): Promise<Product> {
        ...
        try {
            ...
            validated.sku = this.generateSku(validated.name, validated.categoryId, 1);
    ...
    async updateProduct(id: string, dto: UpdateProductDto): Promise<Product> {
        ...
        try {
            ...
            await this.productRepository.updateById(id, { $set: patch });
            ...
            if (validated.variants) {
                ...
                for (const v of toUpdate) {
                    ...
                    await this.variantRepository.updateById(v.id, v);
                }
    ...
    async deleteProduct(id: string) {
        const p = await this.productRepository.deleteById(id);
        return p;
    }
